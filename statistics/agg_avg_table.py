...
for INPUT_DATASET, name in zip(INPUT_DATASETS, names):
    ...
    lang_to_xx = pd.read_csv(os.path.join(BASE_DIR, INPUT_DATASET, 'lang_to_xx_mt5_pretrain.csv'))
    xx_to_lang = pd.read_csv(os.path.join(BASE_DIR, INPUT_DATASET, 'xx_to_lang_mt5_pretrain.csv'))
