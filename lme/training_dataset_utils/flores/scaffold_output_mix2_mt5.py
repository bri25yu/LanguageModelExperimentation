"""
A randomly selected set of scaffold output examples with some baseline
...
RATIO_TRANSLATION = 0.2  # 80% scaffold, 20% translation
TOTAL_EXAMPLES = 10240000
SEED = 42
DATASET_NAME = "flores200_eng_output_scaffolding_mix2_mt5"


def main():
    scaffold_dataset = load_dataset("hlillemark/flores200_eng_output_scaffolding_mt5")["train"]
